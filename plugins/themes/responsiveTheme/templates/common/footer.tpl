			...
			<div id="pageFooter-bottom">
				<div class="container">
					<div class="row">
						<div class="col-md-6 footer-left"><p>{$issnText}: {$issn}</p>{if $pageFooter}{$pageFooter}{/if}</div>
						<div class="col-md-6 footer-right">
							
						
<p>Managed Hosting, Support, and OJS Responsive Theme by:
<a href="http://openjournalsystems.com" title="openjournalsystems.com">OpenJournalSystems.com</a></p>
