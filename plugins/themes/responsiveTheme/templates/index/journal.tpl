...
<ul class="nav nav-tabs" id="indexTab">
  ...
  {if $isHome}
    ...
    <li class="active"><a data-toggle="tab" href="#tab-home">{translate key="plugins.themes.responsiveTheme.aboutJournal"}</a></li>

    <li ><a data-toggle="tab" href="#tab-issue">{translate key="plugins.themes.responsiveTheme.current"}</a></li>

    <li ><a data-toggle="tab" href="#tab-backissue">Back Issue</a></li>

    <li ><a data-toggle="tab" href="#tab-annuncements">{translate key="announcement.announcementsHome"}</a></li>
    ...
    <div class="tab-pane " id="tab-issue">
      ...
      {else}
          <div id="announcements-home">
            <h3>This journal has not published any issues. </h3>
          </div>  
      {/if}  
    </div>
    
    <div class="tab-pane " id="tab-backissue">
