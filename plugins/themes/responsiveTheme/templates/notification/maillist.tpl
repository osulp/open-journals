...
<table class="data" width="100%">
	<tr valign="top">
		<td class="control-label" width="10%">{fieldLabel name="email" key="user.email"}</td>
		<td class="value" width="45%"><input type="text" id="email" name="email" size="30" maxlength="90" class="form-control textField" /></td>
	</tr>
	<tr valign="top">
		<td class="control-label" width="10%">{fieldLabel name="confirmEmail" key="user.confirmEmail"}</td>
		<td class="value" width="45%"><input type="text" id="confirmEmail" name="confirmEmail" size="30" maxlength="90" class="form-control textField" /></td>
	</tr>
	{if $captchaEnabled}
	<tr>
		<td class="control-label" valign="top">{fieldLabel name="captcha" required="true" key="common.captchaField"}</td>
		<td class="value">
			...
			<input name="captcha" id="captcha" value="" size="20" maxlength="32" class="form-control textField" />
	...
	<tr valign="top">
		<td width="10%">&nbsp;</td>
		<td><p><input type="submit" value="{translate key="form.submit"}" class="btn btn-default btn-lg" /></p></td>
	</tr>
</table>
</form>
